...
STRIPE_PRICE_SCHOLAR = os.getenv('STRIPE_PRICE_SCHOLAR')
STRIPE_PRICE_RESEARCHER = os.getenv('STRIPE_PRICE_RESEARCHER')
STRIPE_PRICE_PROFESSOR = os.getenv('STRIPE_PRICE_PROFESSOR')
