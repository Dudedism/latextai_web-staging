...
def login_google():
    ...
    try:
        ...
        redirect_url = f"{FRONTEND_URL}/papers#access_token={access_token}&refresh_token={refresh_token}&email={email}&admin={str(existing_user.get('admin', False)).lower()}&is_new_user={str(is_new_user).lower()}"
